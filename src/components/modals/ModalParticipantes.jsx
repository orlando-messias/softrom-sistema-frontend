...
// MODAL COMPONENT
const ModalParticipantes = ({ handleModal, showModal, idEmpresa, idParticipante, setIdEmpresa, modo }) => {
  ...
  useEffect(() => {
    if (modo === 'edit') {
      ...
      api(user.token).get(`/origem/1/empresa/${idEmpresa}/participante/${idParticipante}`)
